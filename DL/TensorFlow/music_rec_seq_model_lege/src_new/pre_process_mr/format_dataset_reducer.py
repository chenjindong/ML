...
def format_process(vocab_dict, timestamp_col_ids, age_col_ids, float_col_ids, delete_col_ids):
    line_num = 0
    ...
    for line in sys.stdin:
        ...
        try:
            ...
            sys.stdout.write(",".join(cols_final) + "\n")
        except:
            print("error line")
...
if __name__ == "__main__":
    ...
    format_process(vocab_dict, timestamp_col_ids, age_col_ids, float_col_ids, delete_col_ids)
