...
class SeqModelRNNSoftmaxNoCurrent(tf.keras.Model):
    def __init__(self, default_dim, seq_length, song_size, singer_size, sex_size, age_size, time_category_size,
        ...
        super(SeqModelRNNSoftmaxNoCurrent, self).__init__()

        print("SeqModelRNNSoftmaxNoCurrent init")
    ...
    def call(self, inputs, training=False):
        ...
        x = tf.concat([embedding_sex, embedding_age, embedding_history_state], 1)
