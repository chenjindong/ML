...
class SeqModelRNNSoftmaxNoProfile(tf.keras.Model):
    def __init__(self, default_dim, seq_length, song_size, singer_size, sex_size, age_size, time_category_size,
        ...
        super(SeqModelRNNSoftmaxNoProfile, self).__init__()

        print("SeqModelRNNSoftmaxNoProfile init")
    ...
    def call(self, inputs, training=False):
        ...
        x = tf.concat([embedding_current, embedding_history_state], 1)
